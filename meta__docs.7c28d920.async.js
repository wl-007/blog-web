...
console.log(res1)
`,paraId:4,tocIndex:2},{value:`const fs = require('fs')
...
`,paraId:5,tocIndex:3},{value:`const fs = require('fs')

// \u521B\u5EFA\u6587\u4EF6\u5939 directory
fs.mkdir('./why', (err) => {
  console.log(err)
})
`,paraId:6,tocIndex:4},{value:`function readDirectory(path) {
...
readDirectory('./data')
`,paraId:7,tocIndex:5},{value:`const fs = require('fs')
...
`,paraId:8,tocIndex:6},{value:"Node\u4E2D\u7684\u6838\u5FC3API\u90FD\u662F\u57FA\u4E8E\u5F02\u6B65\u4E8B\u4EF6\u9A71\u52A8\u7684",paraId:9,tocIndex:7},{value:`// events\u6A21\u5757\u4E2D\u7684\u4E8B\u4EF6\u603B\u7EBF
...
`,paraId:13,tocIndex:11},{value:`const fs = require('fs')
...
buf[2] = 'm'.charCodeAt()
console.log(buf)
`,paraId:14,tocIndex:13},{value:`fs.readFile('./aaa.txt', { encoding: 'utf-8' }, (err, data) => {
  console.log(data)
})
...
`,paraId:15,tocIndex:14},{value:`const readStream = fs.createReadStream('./aaa.txt', {
 start: 8,
 end: 22,
 highWaterMark: 3
})
...
`,paraId:16,tocIndex:16},{value:`const fs = require('fs')
...
`,paraId:17,tocIndex:17},{value:`// \u521B\u5EFA\u4E00\u4E2A\u5199\u5165\u6D41
...
writeStream.close()
`,paraId:18,tocIndex:18},{value:`const fs = require('fs')
...
`,paraId:19,tocIndex:19},{value:`const http = require('http')
...
`,paraId:20,tocIndex:21},{value:`const http = require('http')
...
`,paraId:21,tocIndex:22},{value:`const http = require('http')
...
`,paraId:22,tocIndex:23},{value:`// 1.\u521B\u5EFAserver\u670D\u52A1\u5668
const server = http.createServer((req, res) => {
  // \u83B7\u53D6\u53C2\u6570: body\u53C2\u6570
...
`,paraId:23,tocIndex:24},{value:`const server = http.createServer((req, res) => {
  console.log(req.headers)
...
`,paraId:24,tocIndex:25},{value:`// 1.\u54CD\u5E94\u6570\u636E\u65B9\u5F0F\u4E00: write
